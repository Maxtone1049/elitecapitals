            ...
            <div id="content" class="bg-dark" style="background-color: #25204a !important">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-white">Profile</h1>
                        <div>
                    ...
                    <div class="container bootstrap snippet">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active row mt-2" id="home" role="tabpanel"
                                        ...
                                        <div class="tab-pane active" id="home">
                                            ...
                                            <form method="POST" action="profile/update">
                                                <input type="hidden" name="_token"
                                                    value="fWlWVQPsC9YzVszi4YXGAjQ5W9NFxAwMTCb56xGz">
                                                <!-- Input Field Starts -->
                                                <div class="form-group">
                                                    <label for="firstname">Firstname</label>
                                                    <input id="firstname" type="text" class="form-control "
                                                        name="firstname" value="<?php echo $row->fname?>" placeholder="Firstname" required
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="lastname" type="text" class="form-control "
                                                        name="lastname" value="<?php echo $row->lname?>" placeholder="Lastname" required
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="email" type="email" class="form-control " name="email"
                                                        value="<?php echo $row->email?>" placeholder="Email" disabled
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="phone_number" type="tel" class="form-control "
                                                        name="phone_number" value="<?php echo $row->phone?>"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="country" type="text" class="form-control " name="country"
                                                        value="<?php echo $row->country?>" required autocomplete="country" disabled
                                                        autofocus />
                                                ...
                                                <div class="form-group">
                                                    <!-- <input class="btn btn-primary" name="_s_up" type="submit" value="Update Profile"
                                        style="width: 100%;"> -->
                                                </div>
