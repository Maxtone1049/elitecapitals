<ul class="navbar-nav sidebar sidebar-dark accordion toggled" id="accordionSidebar" style="background-color: #1f1a40 !important">
    ...
    <!-- Nav Item - Dashboard -->
    <li class=" nav-item ">
        <a class="nav-link" href="upload-id">
            <i class="fa fa-user fa-tachometer-alt"></i>
    ...
    <!-- Nav Item - Dashboard -->
    <li class=" nav-item ">
        <a class="nav-link" href="#" data-toggle="modal" data-target="#walletModal">
    ...
    <li class=" nav-item  active">
        <a class=" nav-link" href="account/upgrade">
            <i class="fa fa-usd fa-tachometer-alt"></i>
